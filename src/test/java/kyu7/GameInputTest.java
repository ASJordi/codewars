...
public class GameInputTest {
    ...
    public void totalInputsTest() {
        ...
        for (Combination eachCombination : combinations) {
            ...
            assertArrayEquals(actual, eachCombination.vector, "Input " + eachCombination.name + " Expected " + Arrays.toString(eachCombination.vector) + " Actual " + Arrays.toString(actual));
        }
