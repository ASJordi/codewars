...
import kyu7.TheOfficeIIBoredomScore.Person;

public class TheOfficeIIBoredomScoreTest {

    @Test
    public void basic1() {
        assertEquals("kill me now", TheOfficeIIBoredomScore.boredom(new Person[] {
    ...
    @Test
    public void basic2() {
        assertEquals("i can handle this", TheOfficeIIBoredomScore.boredom(new Person[] {
                new Person("tim", "IS"),
    ...
    @Test
    public void basic3() {
        assertEquals("party time!!", TheOfficeIIBoredomScore.boredom(new Person[] {
